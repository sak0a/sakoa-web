<template>
  <a 
    ...
    class="btn flex items-center justify-center bg-black text-white transition-colors h-12 rounded-xl px-6 py-3 font-medium text-base sm:text-lg whitespace-nowrap"
    :class="customClass"
  >
...
// Use the provided Revolut URL
const revolutUrl = ref('https://revolut.me/laurinnoel');
</script>
