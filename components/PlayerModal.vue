<template>
  <Teleport to="body">
    ...
    <Transition name="modal-backdrop">
      <div v-if="isOpen" class="modal-backdrop" aria-hidden="true" @click="closeModal"></div>
    </Transition>
      ...
      >
        <div class="modal-content">
          ...
          <Transition name="fade" mode="out-in">
            <div v-if="loading" class="state-container" role="status">
              <div class="loading-spinner">
                <div class="spinner-ring"></div>
                <div class="spinner-ring"></div>
              </div>
              <p id="player-dialog-state" class="state-text">Loading player data...</p>
            </div>
            ...
            <div v-else-if="error" class="state-container" role="alert">
              ...
              <h4 id="player-dialog-state" class="error-title">Player Not Found</h4>
            ...
            <div v-else-if="player" class="player-card">
              <!-- Close button -->
              <button type="button" class="close-btn" aria-label="Close player details" @click="closeModal">
              ...
              <div class="player-header">
                <div class="header-left">
                  ...
                  <div class="header-info">
                    <div class="name-row">
                      <h3 id="player-dialog-title" class="player-name">{{ player.name }}</h3>
              ...
              <div class="primary-stats">
                ...
                <div class="stat-item">
                  <span class="stat-val">{{ formatNumber(player.kills) }}</span>
                  <span class="stat-lbl">Kills</span>
                </div>
                <div class="stat-divider"></div>
                <div class="stat-item">
                  <span class="stat-val">{{ formatNumber(player.deaths) }}</span>
              ...
              <div class="secondary-stats">
                ...
                <div class="sec-stat">
                  <span class="sec-val">{{ formatNumber(player.topspeed) }}</span>
                  <span class="sec-lbl">Top Speed</span>
                </div>
                <div class="sec-stat">
                  <span class="sec-val">{{ formatNumber(player.deflections) }}</span>
...
const fetchPlayerData = async () => {
  ...
  try {
    ...
    if (!response.ok) {
      ...
      error.value = errorData?.error?.message || errorData.message || errorData.statusMessage || `HTTP ${response.status}: ${response.statusText}`;
      return;
    }
    ...
    if (data.success) {
      ...
      error.value = data?.error?.message || data.error || 'Player data could not be loaded.';
    }
  } catch (err) {
...
const handleDialogKeydown = (event) => {
  ...
  const focusable = [...dialogLayer.value.querySelectorAll(
